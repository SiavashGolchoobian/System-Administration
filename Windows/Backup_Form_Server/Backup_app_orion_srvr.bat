...
SET VAR_DEST_DIR_LOCAL=D:\Backups\BP_app_orion_srvr
SET VAR_DEST_DIR_NETWORK=\\172.16.0.39\d$\Backups\BP_app_orion_srvr
...
REM ===================================================================================================================
SET VAR_SOURCE=(D:\hrorionbin D:\orion9)
